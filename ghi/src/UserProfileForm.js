...
const UserProfileForm = () => {
  ...
  const filteredTrips = trips.filter(trip => trip.planner.includes(trip_query))


    return (
        <>
        <div className="my-3 d-flex">
            <div className="shadow p-4 mt-4 container" style={{ width: '225px', height: '250px', display: 'inline-block' }}>
                <input
                    type="text"
                ...
                />
                {profile_pic && <img src={profile_pic} className="img-thumbnail img" alt="" />}
            </div>
        </div>
        <div className="my-3 d-flex">
        ...
        <h1>Trip History</h1>
        <div>
            <label className="form-control my-sm-0" type="text" placeholder="Trip History" onChange={(e) => setTripQuery(e.target.value)}/>
